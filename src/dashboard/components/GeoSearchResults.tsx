...
interface GeoSearchResultsProps {
  ...
  resultRef: React.RefObject<HTMLDivElement> | React.MutableRefObject<HTMLDivElement | null>;
}

export const GeoSearchResults = ({ resultRef, results, onSelect }: GeoSearchResultsProps) => {
